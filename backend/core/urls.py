...
This module defines URL patterns for the admin panel, API endpoints,
static files, and React application routing.
"""
...
urlpatterns = [
    ...
    path('api/auth/csrf/', views_auth.CSRFTokenView.as_view(), name='csrf_token'),
    ...
    path('api/auth/user/', views_auth.UserView.as_view(), name='auth_user'),
